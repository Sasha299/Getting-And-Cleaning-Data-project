...
ytrainData <- read.table("projectData/UCI HAR Dataset/train/y_train.txt")
subjecttrainData <- read.table("projectData/UCI HAR Dataset/train/subject_train.txt")
xtestData <- read.table("projectData/UCI HAR Dataset/test/X_test.txt")
ytestData <- read.table("projectData/UCI HAR Dataset/test/y_test.txt")
subjecttestData <- read.table("projectData/UCI HAR Dataset/test/subject_test.txt")
...
xjoinData <- xjoinData[, meanData]
xjoinData <- xjoinData[, stdData]
...
finalData<- cbind(subjectjoinData, yjoinData, xjoinData)
